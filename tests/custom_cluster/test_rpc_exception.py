...
class TestRPCException(CustomClusterTestSuite):
  ...
  def test_transmitdata_secure_send_lost_connection(self, vector):
    self.execute_query("SSL write: Connection reset by peer")
  ...
  def test_transmitdata_secure_send_timed_out(self, vector):
    self.execute_query("SSL_write: Resource temporarily unavailable")
  ...
  def test_transmitdata_secure_recv_lost_connection(self, vector):
    self.execute_query("SSL_read: Connection reset by peer")
