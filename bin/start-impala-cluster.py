...
parser.add_option("--use_thrift", dest="use_thrift", action="store_true", default=False,
                  help="Enable Thrift during startup of the test cluster.")
