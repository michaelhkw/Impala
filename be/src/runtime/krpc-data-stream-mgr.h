...
/// - Exchange nodes extract data from an incoming stream via a KrpcDataStreamRecvr, which is
...
class KrpcDataStreamMgr : public DataStreamMgrBase {
 ...
 private:
  ...
  typedef boost::unordered_multimap<uint32_t, std::shared_ptr<KrpcDataStreamRecvr>> RecvrMap;
