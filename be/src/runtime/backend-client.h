...
#pragma clang diagnostic ignored "-Woverloaded-virtual"
  ...
  void ExecQueryFInstances(TExecQueryFInstancesResult& _return,
    ...
    DCHECK(!*send_done);
    FAULT_INJECTION_RPC_EXCEPTION(true /* is_send */, 5);
  ...
  void ReportExecStatus(TReportExecStatusResult& _return,
    ...
    DCHECK(!*send_done);
    FAULT_INJECTION_RPC_EXCEPTION(true /* is_send */, 3);
    ImpalaInternalServiceClient::send_ReportExecStatus(params);
    *send_done = true;
    FAULT_INJECTION_RPC_EXCEPTION(false /* is_send */, 3);
  ...
  void TransmitData(TTransmitDataResult& _return, const TTransmitDataParams& params,
      bool* send_done) {
    DCHECK(!*send_done);
    FAULT_INJECTION_RPC_EXCEPTION(true /* is_send */, 1024);
    ...
    *send_done = true;
    FAULT_INJECTION_RPC_EXCEPTION(false /* is_send */, 1024);
