...
#pragma clang diagnostic ignored "-Woverloaded-virtual"
  ...
  void ReportExecStatus(TReportExecStatusResult& _return,
    ...
    DCHECK(!*send_done);
    //FAULT_INJECTION_RPC_EXCEPTION(RPC_REPORTEXECSTATUS, true /* is_send */, 5);
    ImpalaInternalServiceClient::send_ReportExecStatus(params);
    *send_done = true;
    FAULT_INJECTION_RPC_EXCEPTION(RPC_REPORTEXECSTATUS, false /* is_send */, 1);
  ...
  void TransmitData(TTransmitDataResult& _return, const TTransmitDataParams& params,
      bool* send_done) {
    DCHECK(!*send_done);
    FAULT_INJECTION_RPC_EXCEPTION(RPC_TRANSMITDATA, true /* is_send */, 1024);
    ...
    *send_done = true;
    FAULT_INJECTION_RPC_EXCEPTION(RPC_TRANSMITDATA, false /* is_send */, 1024);
