...
Status RowBatch::Serialize(CachedProtoRowBatch* cached_batch) {
  ...
  RETURN_IF_ERROR(Serialize(UseFullDedup(), &cached_batch->tuple_offsets_,
  ...
  // Create slices for 'tuple_offsets' and 'tuple_data'. These slices will be added
  // as sidecars to the RpcController.
