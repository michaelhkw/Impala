...
ir_functions = [
  ...
  ["AGG_NODE_GET_AGG_FN_EVALUATORS",
   "_ZNK6impala15AggregationNode17agg_fn_evaluatorsEv"],
  ["AGG_FN_EVALUATOR_INPUT_EVALUATORS",
   "_ZNK6impala14AggFnEvaluator16input_evaluatorsEv"],
  ...
  ["OLD_HASH_TABLE_GET_BUILD_EXPR_EVALUATORS",
   "_ZNK6impala12OldHashTable21build_expr_evaluatorsEv"],
  ["OLD_HASH_TABLE_GET_PROBE_EXPR_EVALUATORS",
   "_ZNK6impala12OldHashTable21probe_expr_evaluatorsEv"],
  ...
  ["HASH_TABLE_GET_BUILD_EXPR_EVALUATORS",
   "_ZNK6impala12HashTableCtx22GetBuildExprEvaluatorsEv"],
  ["HASH_TABLE_GET_PROBE_EXPR_EVALUATORS",
   "_ZNK6impala12HashTableCtx22GetProbeExprEvaluatorsEv"],
  ["HLL_UPDATE_BOOLEAN",
  ...
  ["HDFS_SCANNER_GET_CONJUNCT_EVALUATOR",
   "_ZNK6impala11HdfsScanner20GetConjunctEvaluatorEi"],
