...
/// Map of global variables'/functions' names to the names of functions they reference.
...
class LlvmCodeGen {
 public:
  ...
  /// when libbackend.so is loaded from java. llvm will by default only look in
 ...
 private:
  ...
  /// A global map which takes the name of either a function or global variable and
  /// returns the set of names of all functions referenced by it.
