...
class TAcceptQueueServer : public TServer {
 ...
 protected:
  ...
  /// Distribution of connection setup time. This does not includes the time spent
  /// waiting for a service thread to be available.
  impala::HistogramMetric* cnxns_setup_time_metric_ = nullptr;

  /// Distribution of wait time for service threads to be available.
  impala::HistogramMetric* thread_wait_time_metric_ = nullptr;
