...
class OldHashTable {
 ...
 private:
  ...
  ScalarExprEvaluator* const* IR_ALWAYS_INLINE build_expr_evaluators() const;
  ScalarExprEvaluator* const* IR_ALWAYS_INLINE probe_expr_evaluators() const;
  ...
  bool EvalRow(TupleRow* row, const std::vector<ScalarExprEvaluator*>& evaluators);
  ...
  std::vector<ScalarExprEvaluator*> filter_expr_evaluators_;
