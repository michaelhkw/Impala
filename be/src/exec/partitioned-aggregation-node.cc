...
void PartitionedAggregationNode::UpdateTuple(FunctionContext** agg_fn_ctxs,
    ExprContext** agg_expr_ctxs, Tuple* tuple, TupleRow* row, bool is_merge) {
...
//   %dst_val = load %"struct.impala::StringValue", %"struct.impala::StringValue"* %dst_slot_ptr
//   store { i8, double } %src, { i8, double }* %src_lowered_ptr
//   %src_unlowered_ptr = bitcast { i8, double }* %src_lowered_ptr to %"struct.impala_udf::DoubleVal"*
...
//   %dst_unlowered_ptr = bitcast { i64, i8* }* %dst_lowered_ptr to %"struct.impala_udf::StringVal"*
...
//       %"class.impala::ExprContext"** %agg_expr_ctxs, i32 1
//   %agg_expr_ctx = load %"class.impala::ExprContext"*, %"class.impala::ExprContext"** %1
...
//       %"class.impala::ExprContext"** %agg_expr_ctxs, i32 2
//   %agg_expr_ctx3 =
//       load %"class.impala::ExprContext"*, %"class.impala::ExprContext"** %3
//   call void @UpdateSlot.3(%"class.impala_udf::FunctionContext"* %agg_fn_ctx2,
//                           %"class.impala::ExprContext"* %agg_expr_ctx3,
//                           { i8, [7 x i8], i64, i64, double }* %tuple1,
//                           %"class.impala::TupleRow"* %row)
//   ret void
// }
Status PartitionedAggregationNode::CodegenUpdateTuple(Function** fn) {
  ...
  PointerType* expr_ctx_ptr_type = codegen->GetPtrType(expr_ctx_type);
  PointerType* expr_ctx_ptr_ptr_type = codegen->GetPtrType(expr_ctx_ptr_type);
  PointerType* fn_ctx_ptr_type = codegen->GetPtrType(fn_ctx_type);
  ...
  prototype.AddArgument(
      LlvmCodeGen::NamedVariable("agg_expr_ctxs", expr_ctx_ptr_ptr_type));
  ...
  *fn = prototype.GeneratePrototype(&builder, &args[0]);
  ...
  Value* agg_expr_ctxs_arg = args[2];
  Value* tuple_arg = args[3];
  ...
  for (int i = 0; i < aggregate_evaluators_.size(); ++i, ++j) {
    ...
    if (evaluator->is_count_star()) {
      ...
      Value* agg_fn_ctx = builder.CreateLoad(fn_ctx_ptr, "agg_fn_ctx");
      Value* agg_expr_ctx_ptr = builder.CreateConstGEP1_32(agg_expr_ctxs_arg, i);
      Value* agg_expr_ctx = builder.CreateLoad(agg_expr_ctx_ptr, "agg_expr_ctx");
