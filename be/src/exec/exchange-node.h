...
class ExchangeNode : public ExecNode {
 ...
 private:
  ...
  /// Release resources of the receiver by transferring the resource ownership of
  /// the most recently dequeued row batch to 'output_batch' and cancel the underlying
